...
class VideoViewer(tkinter.Frame):
    ...
    def __init__(self, master=None):
        ...
        #音声を拾い文字起こしをする
        self.speechToTextGenerator = api_sample.SpeechToTextGenerator()
    ...
    def update_video(self):
        ...
        log, new = self.speechToTextGenerator.get_speech()
        text = ""
        for str in log:
            text += str
        
        ImageDraw.Draw(frame).text((text_loc_x, text_loc_y), text+new, font=self.font, fill=(0, 0, 255, 0))
